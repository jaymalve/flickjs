    ...
    <section className="container pb-12 lg:pb-16">
      <div className="flex flex-col gap-4">
        ...
        <p className="text-base text-stone-400 leading-relaxed">
          Fine-grained reactivity with direct DOM manipulation. No diffing, no
          reconciliation — just surgical updates to exactly what changed. Your
          bundle stays tiny. Your app stays fast.
        </p>
