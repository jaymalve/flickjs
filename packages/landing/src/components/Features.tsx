...
const features = [
  {
    ...
    description:
      'Updates only what changed. No diffing, no reconciliation—just surgical DOM updates.'
  },
  {
    icon: Box,
      ...
      <div className="container">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Every byte counts. Every millisecond matters. Flick is engineered from the ground up for
            speed.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
          {features.map((feature, index) => (
            <div key={index} className="card-glow bg-card p-6 md:p-8 rounded">
